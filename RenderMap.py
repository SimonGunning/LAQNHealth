...
MonitorsDF = pd.read_csv('C:\\Users\\gunning\\Documents\\Anatest\\monlocsFinal.csv')
...
MonitorsDF = pd.merge(wardDF, MonitorsDF, left_on='NAME', right_on='Ward', how='inner')
...
MonitorsDF.plot(ax=base,column='PM10')
